...
#include <linux/mymemorySys.h> // SE INCLUYE LLAMADA A MI SYSCALL
#include <linux/myTrackSyscall.h>
...
// -----------------------  Mis Syscalls --------------------
asmlinkage long sys_capture_memory_snapshot(struct my_memory_snapshot __user *user_snapshot);
...
asmlinkage long sys_moises_tamalloc(size_t size);
